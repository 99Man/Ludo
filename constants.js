...
// let css = "";
// Object.keys(BASE_POSITIONS).forEach(player => {
//     BASE_POSITIONS[player].forEach(([x, y], i) => {
//         css += `
//     [player-id="${player}"][data-piece="${i}"] {
//         left: ${x}%;
//         top: ${y}%;
//         background-color: ${PLAYER_COLORS[player]};
//     }
//     `;
//     });
// });
...
export const STEP_LENGTH = 100 / 15;
